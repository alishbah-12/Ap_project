...
String date,name,day,startTime,endTime;
    ...
    public MovieBooking() {
        ...
        buttons.add(jButton1);
             ...
             buttons.add(jButton50);
              a.Load_movies();
//movie m=a.GetMovie(Calendar.gd);
//System.out.println(m.movie_name);
//for(int k=0;k<m.s.get(0).seat.size();k++)
//{
//    System.out.println(m.s.get(0).seat.get(k).booked);
//}
//            for(int i=0;i<m.s.size();i++) 
//            {
//                for(int j=0;j<m.s.get(i).seat.size();j++)
//                {
//                    if(m.s.get(i).seat.get(j).booked.equals("true"))
//                    {
        ...
        for(int i=0;i<buttons.size();i++)
        {
            ...
            if(buttons.get(i).equals(button))
            {
               movie m;
                ...
                name=m.movie_name;
                j=i+1;
              Boolean b=d.updateSeats(name,j);
               if(b==true)
               {
                   seat_count++;
               }
